...
| **Fortran** | probe | `0.8.2.21` ¹³ | `7aa6f3de…` | **778 · 0F** — 334P/337W/0F/107S ✅ *(was 3F; CAP fix 2026-08-28)* | **FFI-hybrid** (pure-Fortran **signed-carrier uint64** canonical CBOR value codec + C-ABI) | **FFI** — `libentitycore_codec` bound direct via `iso_c_binding`, no C wrapper (libsodium) | deferred (→ FFI, C-ABI `ec_ed448_*`) | `make dist` (git + tarball), `0.1.0-pre` |
