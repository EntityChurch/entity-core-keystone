...
**Cohort:** 42 gate-green peers (**incl. the two authority-as-query declarative frontier probes — `SQL`
...
**Conformance gate:** `validate-peer --profile core` — the extension-free categories (`connectivity`, `encoding`, `type_system`, `origination`, `resource_bounds`, `concurrency`, + the §10.1 register / §7a conformance-handler gates). **All 40 peers are 0-FAIL on this gate.**
