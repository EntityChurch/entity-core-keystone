...
**Cohort:** **46 peers in the tree · 46 measured · all 46 at ONE pin — the 758-check set `c34abcae…` · **46 of the 46 at 0-FAIL** (2026-09-03).** Every number in §1 is a fresh measurement at that pin — nothing is carried forward. **The pin is a content digest, not a commit** — see [The pin](#the-pin--content-anchored-and-why-there-is-no-commit-here) for the full anchor set and how to reproduce a number without access to our `dev` branch.
>
