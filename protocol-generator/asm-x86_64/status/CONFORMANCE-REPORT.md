...
> **CURRENT (2026-09-07) — spec snapshot `v0.8.2.3`, executed check set `c34abcae04c4…`.**
> `validate-peer --profile core` → **PASS, 0 FAIL** · **758 total · 317 pass · 336 warn · 0 FAIL · 105 skip** (elapsed 2505 ms).
>
