...
> **CURRENT (2026-08-30) — spec snapshot `v0.8.2`, executed check set `95edd774f4a2…`.**
> `validate-peer --profile core` → **PASS, 0 FAIL** · **755 total · 313 pass · 336 warn · 0 FAIL · 106 skip** (elapsed 11739 ms).
>
