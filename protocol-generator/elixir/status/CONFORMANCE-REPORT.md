...
> `validate-peer --profile core` → **PASS, 0 FAIL** · **755 total · 312 pass · 337 warn · 0 FAIL · 106 skip** (elapsed 1892 ms).
>
> Re-measured directly against the pinned oracle via
> `tools/run-cohort-census.sh --to-status elixir` — **a measurement, not a copy of the census.**
