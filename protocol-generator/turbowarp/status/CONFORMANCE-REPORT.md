...
> **CURRENT (2026-08-29) — spec snapshot `v0.8.2`, executed check set `95edd774f4a2…`.**
> `validate-peer --profile core` → **PASS, 0 FAIL** · **755 total · 311 pass · 338 warn · 0 FAIL · 106 skip** (elapsed 121321 ms).
>
